...
int main() {
	...
	/*
	 * this is for int and float addition
	 * for (i =0; i<BUFFER_SIZE; i++){
		buffer[i] = (int)rand() / (int)(RAND_MAX);
	}*/
	...
	for (i = 0; i < NUMBER_OF_TRIALS; i++) {
		...
		REPEAT_40(xil_printf("%s\n\r", val));


		//REPEAT_40(XGpio_DiscreteWrite(&Gpio, LED_CHANNEL, i%2)); //Turns on one LED
	...
	//print("Timing for integer addition\n\r");
